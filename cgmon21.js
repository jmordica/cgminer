...
config = _.defaults(config, {
    ...
    "processName": "cgminer21",             // name cgmon uses to find process ID
    "startWaitSeconds": 5,                // time to wait for miner process to start before continuing
    "cmd": "/opt/cgminer/start_screen/start_screen21.sh",           // process cgmon spawns to start cgminer
    "args": [],                           // process arguments if any
    "apiHost": "127.0.0.1",               // miner API host
    "apiPort": "4321",                    // miner API port
