...
config = _.defaults(config, {
    ...
    "processName": "cgminer26",             // name cgmon uses to find process ID
    "startWaitSeconds": 5,                // time to wait for miner process to start before continuing
    "cmd": "/opt/cgminer/start_screen/start_screen26.sh",           // process cgmon spawns to start cgminer
    "args": [],                           // process arguments if any
    "apiHost": "127.0.0.1",               // miner API host
    "apiPort": "4326",                    // miner API port
